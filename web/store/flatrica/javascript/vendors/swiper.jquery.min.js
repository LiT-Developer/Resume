...
!function() {
    ...
    var a, t = function(e, s) {
        ...
        0 !== y.container.length)) {
            ...
            y.params.pagination && (y.paginationContainer = a(y.params.pagination),
            ...
            y.params.prevButton && (y.prevButton = a(y.params.prevButton),
                ...
                if ("undefined" != typeof y.size) {
                    ...
                    for (e = 0; e < y.slides.length; e++) {
                        ...
                        if (y.params.slidesPerColumn > 1) {
                            var c, m, f;
                            "column" === y.params.slidesPerColumnFill ? (m = Math.floor(e / l),
                            f = e - m * l,
                            (m > d || m === d && f === l - 1) && ++f >= l && (f = 0,
                            m++),
                            c = m + f * n / l,
                            u.css({
            ...
            y.updateClasses = function() {
                ...
                y.paginationContainer && y.paginationContainer.length > 0) {
                    ...
                    r > i - 1 && (r -= i),
                    0 > r && "bullets" !== y.params.paginationType && (r = i + r)) : r = "undefined" != typeof y.snapIndex ? y.snapIndex : y.activeIndex || 0,
                    ...
                    y.paginationContainer.find("." + y.params.paginationTotalClass).text(i)),
            ...
            y.onTouchMove = function(e) {
                ...
                !G || "mousemove" !== e.type) {
                    ...
                    !(e.targetTouches && e.targetTouches.length > 1)) {
                        ...
                        if (M && y.emit("onTouchMoveOpposite", y, e),
                        ...
                        T) {
                            ...
                            if (A || !y.browser.ieTouch) {
                                ...
                                y.params.resistance && (P = y.minTranslate() - 1 + Math.pow(-y.minTranslate() + I + r, y.params.resistanceRatio))) : 0 > r && P < y.maxTranslate() && (i = !1,
            ...
            y.onTouchEnd = function(e) {
                ...
                T) {
                    ...
                    y.emit("onTap", y, e),
                    300 > s && t - L > 300 && (E && clearTimeout(E),
                    ...
                    300 > s && 300 > t - L && (E && clearTimeout(E),
                    ...
                    y.params.freeMode) {
                        ...
                        if (y.params.freeModeMomentum) {
                            ...
                            y.params.freeModeMomentumBounce && m ? (y.updateProgress(c),
                            y.setWrapperTransition(p),
                            y.setWrapperTranslate(u),
                            y.onTransitionStart(),
                            y.animating = !0,
                            y.wrapper.transitionEnd(function() {
                                y && B && (y.emit("onMomentumBounce", y),
                    ...
                    for (v = 0; v < y.slidesGrid.length; v += y.params.slidesPerGroup)
                        "undefined" != typeof y.slidesGrid[v + y.params.slidesPerGroup] ? r >= y.slidesGrid[v] && r < y.slidesGrid[v + y.params.slidesPerGroup] && (w = v,
                    ...
                    setTranslate: function() {
                        for (var e = 0; e < y.slides.length; e++) {
                            ...
                            var r = t[0].swiperSlideOffset
                              ...
                              , l = -r
                              , p = 0;
                            if (y.isHorizontal() ? y.rtl && (n = -n) : (p = l,
                            l = 0,
                            o = -n,
                            n = 0),
                            ...
                            y.params.flip.slideShadows) {
                                ...
                                t.append(d)),
                                0 === u.length && (u = a('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "right" : "bottom") + '"></div>'),
                                t.append(u)),
                    ...
                    setTranslate: function() {
                        ...
                        for (var s = 0; s < y.slides.length; s++) {
                            ...
                            y.params.cube.slideShadows) {
                                ...
                                r.append(c)),
                                0 === m.length && (m = a('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "right" : "bottom") + '"></div>'),
                                r.append(m)),
                    ...
                    setTranslate: function() {
                        for (var e = y.translate, t = y.isHorizontal() ? -e + y.width / 2 : -e + y.height / 2, s = y.isHorizontal() ? y.params.coverflow.rotate : -y.params.coverflow.rotate, r = y.params.coverflow.depth, i = 0, n = y.slides.length; n > i; i++) {
                            ...
                            y.params.coverflow.slideShadows) {
                                ...
                                o.append(v)),
                                0 === w.length && (w = a('<div class="swiper-slide-shadow-' + (y.isHorizontal() ? "right" : "bottom") + '"></div>'),
                                o.append(w)),
            ...
            y.a11y = {
                ...
                onEnterKey: function(e) {
                    13 === e.keyCode && (a(e.target).is(y.params.nextButton) ? (y.onClickNext(e),
                    y.isEnd ? y.a11y.notify(y.params.lastSlideMessage) : y.a11y.notify(y.params.nextSlideMessage)) : a(e.target).is(y.params.prevButton) && (y.onClickPrev(e),
